...
namespace MethodsAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Your number times 5 is equal to: " + letsOperate.timesFive(num) +
                "\nYour number plus 5 is equal to: " + letsOperate.plusFive(num) +
                "\nYour number minus 5 is equal to: " + letsOperate.minusFive(num));
            Console.ReadLine();
        }
    }
}
